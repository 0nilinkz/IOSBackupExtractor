...
namespace IOSBackupExtractor
{
    public partial class Form1 : Form
    {
        ...
        private void ExtractionButton_Click(object sender, EventArgs e)
        {
            ...
            {
                if (BrowserDialog1.SelectedPath != string.Empty)
                {
                    MessageBox.Show("Backup location folders Must be provided.");
                }
                else
                {
                    MessageBox.Show("Destination save location folders Must be provided.");
                }
            }
        }
